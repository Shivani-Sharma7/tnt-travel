...
export default function ServiceCards() {
  ...
  return (
    <div style={{flex:'2 1 400px',display:'flex',gap:'2rem',flexWrap:'wrap',justifyContent:'center',position:'relative'}}>
      ...
      >
        <img src="/activity/custimizelist.png" alt="Customize Trip" style={{width:'100%',height:'140px',objectFit:'cover',borderRadius:'1rem 1rem 0 0',marginBottom:'1rem'}} />
        ...
        <h3 style={{fontWeight:700,fontSize:'1.2rem',color:'#8B5C3C',margin:'1.2rem 0 0.5rem 0'}}>Customize Trip</h3>
        <p style={{color:'#A66A43',fontSize:'1rem',textAlign:'center'}}>Customize your own activities, hotels, cabs, and more for a truly personalized experience.</p>
      </button>
      {/* Card 2: Taxi */}
      <button
      ...
      >
        <img src="/activity/taxi.jpg" alt="Taxi" style={{width:'100%',height:'140px',objectFit:'cover',borderRadius:'1rem 1rem 0 0',marginBottom:'1rem'}} />
        <div style={{position:'absolute',top:120,left:20,background:'#fff',borderRadius:'50%',padding:'0.5rem',boxShadow:'0 2px 8px rgba(0,0,0,0.08)'}}>
          <span role="img" aria-label="badge">🏅</span>
        </div>
      ...
      >
        <img src="/activity/hotels.jpg" alt="Hotels" style={{width:'100%',height:'140px',objectFit:'cover',borderRadius:'1rem 1rem 0 0',marginBottom:'1rem'}} />
        <div style={{position:'absolute',top:120,left:20,background:'#fff',borderRadius:'50%',padding:'0.5rem',boxShadow:'0 2px 8px rgba(0,0,0,0.08)'}}>
          <span role="img" aria-label="badge">🏅</span>
        </div>
